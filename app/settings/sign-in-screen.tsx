  ...
  return (
    <SafeAreaView className="flex-1 bg-[#262e3d]">
      ...
      <View className="flex-1 justify-center items-center p-6 -mt-16">
        <View className="bg-[#3a4151] rounded-xl w-14 h-14 items-center justify-center mb-6">
      ...
      <View className="p-6 border-t border-t-gray-700">
        <View className="space-y-4">
          ...
          <TouchableOpacity className="bg-[#3a4151] rounded-xl py-4 flex-row items-center justify-center">
