...
const OPTIONS = [
  { label: 'Healing past', icon: 'archive' },
  { label: 'Setting goals', icon: 'target' },
      ...
      >
        <View className="mb-12">
          <Text className="text-[#E2E8F0] text-4xl font-bold tracking-tighter leading-tight">
            Been avoiding anything you should confront?
          </Text>
          <Text className="text-[#94A3B8] text-lg mt-4 leading-relaxed">
            Addressing the friction points is the path to true growth.
          </Text>
