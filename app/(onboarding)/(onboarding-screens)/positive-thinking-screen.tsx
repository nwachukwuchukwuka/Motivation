...
const OPTIONS = [
  { label: "Yes, I believe that", icon: "check-circle" },
  { label: "Heard of it, unsure", icon: "info" },
  { label: "Tell me more", icon: "book-open" },
  { label: "Skeptical, but open", icon: "eye" },
];
      ...
      >
        <View className="mb-12">
          ...
          <Text className="text-[#94A3B8] text-lg mt-4 leading-relaxed">
            Science confirms that focus changes your neural architecture.
          </Text>
