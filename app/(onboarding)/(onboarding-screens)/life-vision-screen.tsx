...
const VISION_OPTIONS = [
  { label: "Yes, I do", icon: "check-circle" },
  { label: "Working on it", icon: "compass" },
  { label: "Day by day", icon: "sun" },
  { label: "Not really", icon: "help-circle" },
];
      ...
      >
        <View className="mb-12">
          ...
          <Text className="text-[#94A3B8] text-lg mt-4 leading-relaxed">
            Your clarity defines the path we build together.
          </Text>
          <View className="w-12 h-1 bg-emerald-500 mt-6" />
        </View>

        <View className="flex-row flex-wrap justify-between">
          {VISION_OPTIONS.map((item) => {
