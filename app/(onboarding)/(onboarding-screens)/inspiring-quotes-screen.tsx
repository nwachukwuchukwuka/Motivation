...
const QUOTE_OPTIONS = [
  { label: "From people I admire", icon: "users" },
  { label: "Short and to the point", icon: "zap" },
  { label: "Tough love", icon: "frown" },
  { label: "Spiritual", icon: "sun" },
  { label: "Thought-provoking", icon: "book-open" },
  { label: "Wise & Ancient", icon: "anchor" },
];

const InspiringQuotesScreen = () => {
  ...
  const handleContinue = () => {
    router.push("/quote-actions-screen");
  };
      ...
      >
        <View className="mb-12">
          <Text className="text-[#E2E8F0] text-4xl font-bold tracking-tighter leading-tight">
            What kind of quotes inspire you most?
          </Text>
          <Text className="text-[#94A3B8] text-lg mt-4 leading-relaxed">
            Select the voices that resonate with your mindset.
          </Text>
...
export default InspiringQuotesScreen;
